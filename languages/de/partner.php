<?php
# $partner['index']['contant']['text'][''][]

$partner = array(
	'index' => array(
		'title' => 'Partner',
		'description' => 'Ich bin ein vertrauenswürdiger Partner, der hochwertige Websites für Ihre Bedürfnisse anbietet. Ob Sie nach einer Website für Informationen, Unterhaltung, Shopping oder Dienstleistungen suchen, ich empfehle Ihnen die bestmögliche Auswahl. Entdecken Sie meine Auswahl an Partnerseiten und nutzen Sie deren Vorteile.',
		'keyword' => '',
		'url' => array(
			'default' => 'partner',
			'de' => 'partner'
		...
		'content' => array(
			'text' => array(
				...
				'5' => 'WPML Translate ist ein WordPress-Plugin, mit dem Sie ganz einfach mehrsprachige Websites erstellen können. Mit WPML Translate können Sie alles auf Ihrer Website übersetzen, einschließlich Seiten, Beiträge, Menüs, Widgets, Themes und Plugins. Sie können die verschiedenen Sprachen Ihrer Website auch über ein zentrales Dashboard verwalten. WPML Translate ist mit den meisten WordPress-Themes und -Plugins kompatibel und bietet Ihnen ein einfaches und effizientes Übersetzungserlebnis.',
				'6' => 'Shine.fr ist eine Website, die Coaching- und Schulungsdienste für Unternehmer anbietet. Unabhängig davon, ob Sie Selbstunternehmer, Freiberufler, Handwerker oder Händler sind, können Sie von der persönlichen Unterstützung von Shine.fr profitieren, um Ihr Unternehmen weiterzuentwickeln, Ihre Konten zu verwalten und Ihre Besteuerung zu optimieren. Shine.fr bietet Ihnen auch eine an Ihre Bedürfnisse angepasste Neobank mit einem professionellen Konto, einer Bankkarte und vereinfachten Verwaltungstools.',
				'7' => '',
				'8' => '',
				'9' => '',
				'10' => '',
