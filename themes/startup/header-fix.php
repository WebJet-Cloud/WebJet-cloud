    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <video class="img-fluid" autoplay loop muted>
                        <source src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir']; ?>/startup/webjet-intro.mp4" type="video/mp4" />
                    </video>    
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown"><?php echo $general['pages']['menu']['header']['creative']; ?></h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn"><?php echo $sites['domain']; ?></h1>
                            <a href="<?php echo $protocols.'://'.$domainTLD.'/'.$email['ask-quotes']['url']['default']; ?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"><?php echo $email['ask-quotes']['title']; ?></a>
                            <a href="<?php echo $protocols.'://'.$domainTLD.'/'.$email['index']['url']['default']; ?>" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight"><?php echo $email['index']['title']; ?></a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown"><?php echo $general['pages']['menu']['header']['innovation']; ?></h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn"><?php echo $general['pages']['menu']['header']['os-php']; ?> </h1>
                            <a href="<?php echo $protocols.'://'.$domainTLD.'/'.$email['ask-quotes']['url']['default']; ?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"><?php echo $email['ask-quotes']['title']; ?></a>
                            <a href="<?php echo $protocols.'://'.$domainTLD.'/'.$email['index']['url']['default']; ?>" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight"><?php echo $email['index']['title']; ?></a>
                        </div>
                    </div>
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#header-carousel" data-bs-slide="prev">
                ...
                <span class="visually-hidden"><?php echo $general['pages']['full']['previous']; ?></span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#header-carousel" ata-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden"><?php echo $general['pages']['full']['next']; ?></span>
            </button>
        </div>
    </div>
    <!-- Navbar & Carousel End -->
