    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php echo $email['index']['title']; ?></h5>
                <h1 class="mb-0"><?php echo $email['index']['content']['container']['slogan']; ?></h1>
            </div>
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2"><?php echo $email['index']['content']['container']['blocks']['1']; ?></h5>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2"><?php echo $email['index']['content']['container']['blocks']['2']; ?></h5>
                            <h4 class="text-primary mb-0"><?php echo $private['mail']['public'].'[AT]'.$sites['domain']; ?></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2"><?php echo $email['index']['content']['container']['blocks']['3']; ?></h5>
                            <h4 class="text-primary mb-0"> <?php echo $private['city'].', '.$private['contry']; ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form method="post" role="form" class="php-email-form">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <input type="email" name="email" class="form-control border-0 bg-light px-4" placeholder="<?php echo $email['index']['content']['default']['email']; ?>" style="height: 55px;">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" name="subject" placeholder="<?php echo $email['index']['content']['default']['subject']; ?>" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" name="message" rows="4" placeholder="<?php echo $email['index']['content']['default']['message']; ?>"></textarea>
                            </div>
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d83998.9541068226!2d2.276995358050675!3d48.858833639375185!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b70f%3A0x40b82c3688c9460!2sParis!5e0!3m2!1sfr!2sfr!4v1662220974581!5m2!1sfr!2sfr"
