                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="<?php echo $protocols.'://lives.'.$sites['domain']; ?>/forums/"><i class="bi bi-arrow-right text-primary me-2"></i><?php echo $general['pages']['menu']['undermenu']['forum-c']; ?></a>
