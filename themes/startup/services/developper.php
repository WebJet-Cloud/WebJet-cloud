                    ...
                    <!--<table class="table table-striped align-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="align-middle">
                                ...
                                <td><?php echo $services['developper']['content']['excel']['table']['body']['1']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <td><?php echo $services['developper']['content']['excel']['table']['body']['2']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <td><?php echo $services['developper']['content']['excel']['table']['body']['3']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <td><?php echo $services['developper']['content']['excel']['table']['body']['4']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <td><?php echo $services['developper']['content']['excel']['table']['body']['5']['tr']['3']; ?></td>
                            </tr>
                        </tbody>
                    </table>-->
                </div>
