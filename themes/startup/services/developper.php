        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['developper']['content']['secteur']['1']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['developper']['content']['secteur']['1']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['developper']['content']['secteur']['1']['text']; ?>
            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir'].'/'.$images['manager']['services']['developper']['1']; ?>" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir'].'/'.$images['manager']['services']['developper']['2']; ?>" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['developper']['content']['secteur']['2']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['developper']['content']['secteur']['2']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['developper']['content']['secteur']['2']['text']; ?>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    ...
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['developper']['content']['secteur']['3']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['developper']['content']['secteur']['3']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['developper']['content']['secteur']['3']['text']; ?>
            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir'].'/'.$images['manager']['services']['developper']['3']; ?>" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir'].'/'.$images['manager']['services']['developper']['4']; ?>" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">

                 <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['developper']['content']['secteur']['4']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['developper']['content']['secteur']['4']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['developper']['content']['secteur']['4']['text']; ?>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    ...
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['developper']['content']['secteur']['5']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['developper']['content']['secteur']['5']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['developper']['content']['secteur']['5']['text']; ?>
            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir'].'/'.$images['manager']['services']['developper']['5']; ?>" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="bg-light rounded">
                        <div class="p-5 pt-0">
                            <h1 class="display-5 mb-3">
                                <small class="align-top" style="font-size: 22px; line-height: 45px;"> <?php echo $services['developper']['content']['pricing']['free']; ?></small>
                            </h1>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                        <div class="p-5 pt-0">
                            ...
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['developper']['content']['secteur']['1']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['developper']['content']['secteur']['2']['h1']; ?></span><i class="fa fa-times text-danger pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['developper']['content']['secteur']['3']['h1']; ?></span><i class="fa fa-times text-danger pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span><?php echo $services['developper']['content']['secteur']['4']['h1']; ?></span><i class="fa fa-times text-danger pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span><?php echo $services['developper']['content']['secteur']['5']['h1']; ?></span><i class="fa fa-times text-danger pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span><?php echo $services['webmaster']['content']['pricing']['fees-seo']; ?></span></div>
                            <a href="<?php echo $protocols.'://stores.'.$sites['domain']; ?>/all/numerique/creation-de-site-vitrine/" class="btn btn-primary py-2 px-4 mt-4"><?php echo $services['developper']['content']['secteur']['6']['h5']; ?></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="bg-light rounded">
                        <div class="p-5 pt-0">
                            ...
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['developper']['content']['secteur']['1']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['developper']['content']['secteur']['2']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['developper']['content']['secteur']['3']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span><?php echo $services['developper']['content']['secteur']['4']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span><?php echo $services['developper']['content']['secteur']['5']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-2"><span><?php echo $services['webmaster']['content']['pricing']['fees-seo']; ?></span></div>
                            <a href="#' class="btn btn-primary py-2 px-4 mt-4"><?php echo $services['developper']['content']['pricing']['not-propose']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
