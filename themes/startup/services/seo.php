...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['intro']['title']; ?></h5>
                <h1 class="mb-0"><?php echo $services['seo']['content']['intro']['description']; ?></h1>
            </div>
            <div class="row g-5">
                <p>
                <?php echo $services['seo']['content']['intro']['text']; ?>
                </p>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['excel']['title']; ?></h5>
                <h1 class="mb-0"><?php echo $services['seo']['content']['excel']['description']; ?></h1>
            </div>
            <div class="row g-5">
                    ...
                    <table class="table table-striped align-middle">
                        <thead>
                            <tr class="align-middle">
                                <th scope="col"><?php echo $services['seo']['content']['excel']['table']['head']['1']; ?></th>
                                <th scope="col"><?php echo $services['seo']['content']['excel']['table']['head']['2']; ?></th>
                                <th scope="col"><?php echo $services['seo']['content']['excel']['table']['head']['3']; ?></th>
                            </tr>
                        </thead>
                        <tbody>
                                
                            <tr class="align-middle">
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['1']['tr']['1']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['1']['tr']['2']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['1']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['2']['tr']['1']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['2']['tr']['2']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['2']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['3']['tr']['1']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['3']['tr']['2']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['3']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['4']['tr']['1']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['4']['tr']['2']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['4']['tr']['3']; ?></td>
                            </tr>
                            <tr class="align-middle">
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['5']['tr']['1']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['5']['tr']['2']; ?></td>
                                <td><?php echo $services['seo']['content']['excel']['table']['body']['5']['tr']['3']; ?></td>
                            </tr>
                                
                                <tr class="align-middle">
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['6']['tr']['1']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['6']['tr']['2']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['6']['tr']['3']; ?></td>
                                </tr>
                                <tr class="align-middle">
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['7']['tr']['1']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['7']['tr']['2']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['7']['tr']['3']; ?></td>
                                </tr>
                                <tr class="align-middle">
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['8']['tr']['1']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['8']['tr']['2']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['8']['tr']['3']; ?></td>
                                </tr>
                                <tr class="align-middle">
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['9']['tr']['1']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['9']['tr']['2']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['9']['tr']['3']; ?></td>
                                </tr>
                                <tr class="align-middle">
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['10']['tr']['1']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['10']['tr']['2']; ?></td>
                                    <td><?php echo $services['seo']['content']['excel']['table']['body']['10']['tr']['3']; ?></td>
                                </tr>
                        </tbody>
                    </table>
                </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['for-pro']['title']; ?></h5>
                <h1 class="mb-0"><?php echo $services['seo']['content']['for-pro']['description']; ?></h1>
            </div>
            <div class="row g-5">
                <p>
                <?php echo $services['seo']['content']['for-pro']['text']; ?>
                </p>
            </div>
        </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['secteur']['1']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['seo']['content']['secteur']['1']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['seo']['content']['secteur']['1']['text']; ?>
            </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['secteur']['2']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['seo']['content']['secteur']['2']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['seo']['content']['secteur']['2']['text']; ?>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    ...
                    <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['secteur']['3']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['seo']['content']['secteur']['3']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['seo']['content']['secteur']['3']['text']; ?>
            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                 ...
                 <h5 class="fw-bold text-primary text-uppercase"><?php echo $services['seo']['content']['secteur']['4']['h5']; ?></h5>
                    <h1 class="mb-0"><?php echo $services['seo']['content']['secteur']['4']['h1']; ?></h1>
                </div>
                <p class="mb-4"></p>
                <?php echo $services['seo']['content']['secteur']['4']['text']; ?>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="bg-light rounded">
                        <div class="p-5 pt-0">
                            ...
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['seo']['content']['secteur']['1']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
                            <div class="d-flex justify-content-between mb-3"><span><?php echo $services['seo']['content']['secteur']['2']['h1']; ?></span><i class="fa fa-check text-primary pt-1"></i></div>
