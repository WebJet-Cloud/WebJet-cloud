    ...
    //-->
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="<?php echo $protocols.'://'.$domainTLD; ?>" class="btn custom-btn d-lg-none ms-auto me-4">Buy Ticket</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_index"><?php echo $general['index']['title']; ?></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_aboutus"><?php echo $general['aboutus']['title']; ?></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_services"><?php echo $general['services']['title']; ?></a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_pricing"><?php echo $general['pages']['menu']['undermenu']['pricing']; ?></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_email"><?php echo $email['index']['title']; ?></a>
                        </li>
                    </ul>

                    <a href="<?php echo $protocols.'://'.$domainTLD.'/'.$email['ask-quotes']['url']['default']; ?>" class="btn custom-btn d-lg-block d-none"><?php echo $email['ask-quotes']['title']; ?></a>
                </div>
            </div>
        </nav>


        <section class="hero-section" id="section_index">
            ...
            <div class="container d-flex justify-content-center align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-auto mb-5 text-center">
                        <small><?php echo $sites['domain']; ?></small>

                        <h1 class="text-white mb-5"><?php echo $general['pages']['menu']['header']['os-php']; ?> </h1>

                        <a class="btn custom-btn smoothscroll" href="#section_aboutus"><i class="fa-solid fa-down"></i></a>
                    </div>
                    ...
                    <div class="col-lg-12 col-12 mt-auto d-flex flex-column flex-lg-row text-center">
                        <div class="date-wrap">
                            <h5 class="text-white">
                                ...
                                <sup><?php echo $general['full']['clock']['1']; ?><br />
                                    <?php echo $general['full']['clock']['2']; ?><br />
                                    <?php echo $general['full']['clock']['3']; ?><cd</sup>
                            </h5>
                        </div>
            ...
            <div class="video-wrap">
                <video autoplay="" loop="" muted="" class="custom-video" poster="">
                    <source src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['manager']['intro-vdo']; ?>" type="video/mp4">
