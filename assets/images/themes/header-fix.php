...
<!--Template-->
  ...
  <link href="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$version['internal']['production']['css']['startup']; ?>" rel="stylesheet">
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo $version['external']['animate']['css']; ?>" rel="stylesheet">
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Paris, France</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+012 345 6789</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>services[AT]WebJet.cloud</small>
                </div>
            </div>
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://twitter.com/webjetclouds"><i class="fab fa-twitter fw-normal"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://facebook.com/WebJetclouds"><i class="fab fa-facebook-f fw-normal"></i></a>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="index.html" class="navbar-brand p-0">
                <h1 class="m-0"><i class="fa-solid fa-rocket me-2"></i> WebJet</h1>
            </a>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="https://lives.webjet.cloud/register" class="dropdown-item">Nos Tarification</a>
                            <a href="#" class="dropdown-item">Nos fonctionnalités</a>
                            <a href="#" class="dropdown-item">Membres de l'équipe</a>
                            <a href="#" class="dropdown-item">Devis Gratuit</a>
                        </div>
                    </div>
                    <a href="#" class="nav-item nav-link">Contact</a>
                </div>
                <a href="https://github.com/WebJet-Cloud/WebJet-cloud/releases" class="btn btn-primary py-2 px-4 ms-3">Télécharger</a>
            </div>
        </nav>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <video class="img-fluid" autoplay loop muted>
                        <source src="video/webjet-intro.mp4" type="video/mp4" />
                    </video>    
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Créative</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">WebJet.Cloud</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Devis Gratuit</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Innovante</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Open Source PHP </h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Devis Gratuit</a>
                            <a href="" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Nous contacter</a>
                        </div>
                    </div>
